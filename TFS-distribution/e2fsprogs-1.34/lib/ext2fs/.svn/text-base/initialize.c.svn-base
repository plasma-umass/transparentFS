...
retry:
	 ...
	 */
/*it also includes the lowPriority bitmaps, and dirty bitmaps */
	overhead = (int) (5 + fs->desc_blocks + fs->inode_blocks_per_group);
	...
	sprintf(buf, "dirty block bitmap for %s", fs->device_name);
