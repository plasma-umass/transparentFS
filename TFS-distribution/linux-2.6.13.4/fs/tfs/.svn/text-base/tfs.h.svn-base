...
struct tfs_inode_info {
	...
	/* JC - transparency field in inode_info */
	__u16	i_transparency;
	/* /JC */
...
extern int tfs_lockBlock(struct super_block *sb, int goal);
extern int tfs_unlockBlock(struct super_block *sb, int goal);
extern int tfs_isBlockStillMine(struct inode *inode, int block);
...
extern int tfs_step_blocks(struct inode *inode, int (*func)(struct inode *, int, int));
...
extern int tfs_find_zero_byte(int count, char ** bitmaps, int start, int end);
extern int tfs_p_find_first_zero_byte(char *highp, char *lowp, char *dirty, char *blocklock,char *allocationPredictor, int start, 
				int length, int priority, int blocksPerAllocHint);
extern int tfs_p_set_bit(int j, char *highp, char *lowp, char *dirty, char *blocklock, char * allocationPredictor, int priority, int blocksPerAllocHint);
extern int tfs_p_set_bit_atomic(spinlock_t *lock, int j, char *highp, char *lowp, char *dirty, char *blocklock,char * allocationPredictor, int priority, int blocksPerAllocHint);
extern int tfs_p_test_bit(int j, char *highp, char *lowp, char *dirty, char *blocklock,char * allocationPredictor, int priority, int blocksPerAllocHint);
extern int tfs_p_find_next_zero_bith(int count, char **bitmaps, int start, int end);
extern int tfs_p_find_next_zero_bit(char *highp, char *lowp, char *dirty, char *blocklock, char * allocationPredictor,
